...
INSERT INTO etat(id_etat, libelle_etat) VALUES (1,'expedier'),
    ...
    mycursor.execute(sql)
    sql = ''' 
    INSERT INTO lunette(id_lunette, nom_lunette, sexe, indice_protection, taille_monture, prix_lunette, image, stock, fournisseur, marque, description,categorie_id, couleur_id) VALUES (1,'mirage','h',3,4,267.98,'lunette1.webp',2,1,'Rayban', 'top',1, 1),
                                                                                                                                                                  (2,'meta','h',3,2,478.87,'lunette2.webpp',1,2,'Fendi', 'top',2, 7),
                                                                                                                                                                  (3,'infinity','f',4,5,980.67,'lunette3.webp',100,3,'Optic2000', 'top',1,2),
                                                                                                                                                                  (4,'vortex','h',1,1,750,'lunette4.webp',50,1,'KABOOM', 'top',1,3),
                                                                                                                                                                  (5,'Fendigraphy','f',4,4,375.3,'lunette5.webp',5,1,'Furet', 'top',2,4),
                                                                                                                                                                  (6,'MAG450 ','h',1,1,50.0,'lunette6.webp',589,1,'LV', 'top',1,5),
                                                                                                                                                                  (7,'Orbis-Quadrum','h',3,2,234.67,'lunette7.webp',0,2,'Liketheview', 'top',1,6),
                                                                                                                                                                  (8,'X-Fit','h',3,4,999.99,'lunette8.webp',45,3,'pipo', 'top',4,7),
                                                                                                                                                                  (9,'Cobra Competizione','f',2,3,65.0,'lunette9.webp',45,3,'Rayban', 'top',4,8),
                                                                                                                                                                  (10,'Fastskin','h',1,2,55.55,'lunette10.webp',43,2,'Fendi', 'top',4,9),
                                                                                                                                                                  (11,'Lys ','h',4,3,110.0,'lunette11.webp',23,3,'chut', 'top',1,1),
                                                                                                                                                                  (12,' GC X Speed','h',3,4,940,'lunette12.webp',20,2,'Optic2000','top',3,2),
                                                                                                                                                                  (13,'Flower','h',5,5,275.0,'lunette13.webp',23,1,'KABOOM','top',2,3),
                                                                                                                                                                  (14,'ClassicFly ','f',3,4,145.0,'lunette14.webp',2,2,'Athena','top',2,4),
                                                                                                                                                                  (15,' CT0092O','h',3,3,850.0,'lunette15.webp',45,1,'glow','top',1,5),
                                                                                                                                                                  (16,'GC Speed Max','h',5,3,130.0,'lunette16.webp',1,3,'fiou','top',3,6),
                                                                                                                                                                  (17,'Vintage','h',2,3,80.0,'lunette17.webp',230,1,'gru','top',1,7),
                                                                                                                                                                  (18,'Prisme','h',3,2,190,'lunette18.webp',34,1,'top1','top',2,8),
                                                                                                                                                                  (19,'Bee','f',2,3,225.0,'lunette19.webp',3,2,'Lastreet','top',1,9),
                                                                                                                                                                  (20,'Hot Rod','h',3,4,140,'lunette20.webp',4,1,'Lastreet','top',2,1);
         '''
    mycursor.execute(sql)
